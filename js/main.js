...
controls()
{
	$(".subnav a")
		.on	('click', function()
		{
			...
			$(parent).find(".subsection.sec"+onItem).addClass("on");
			$(this).addClass("on");

			$(parent).find(".subsection.sec"+onItem).children(".content").children("div, img").each(function()
			{
				fadeTime += fadeInc;
			...
			$(parent).find(".subsection.sec"+onItem).children(".content").children("p").each(function()
			{
				fadeTime += fadeInc;
